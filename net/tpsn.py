...
class TPSN(SegHBSNNet):
    ...
    def build_model(self):
        # self.model = UNet(3, 2, IsSeg=True)
        self.model = UNet(
            3, 2, [64, 128, 256, 512], [64, 128, 256, 512], is_skip=True
        )
        ...
        mask_temp = torch.ones([1, 1, self.config.height, self.config.width])
    ...
    def initialize(self):
        super().initialize()
        self.model.outc.weight.data.zero_()
